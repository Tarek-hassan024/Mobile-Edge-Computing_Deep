...
class DeepQNetwork:
    def __init__(self,
        ...
        self.replace_target_op = [tf.compat.v1.assign(t, e) for t, e in zip(t_params, e_params)]  # update target_net
    ...
    def _build_net(self):
        ...
        with tf.compat.v1.variable_scope('eval_net'):
            ...
            # tf.random_normal_initializer(mean=0.0, stddev=1.0, seed=None, dtype=tf.float32), return an initializer
