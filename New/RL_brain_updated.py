...
class DeepQNetwork:
    ...
    def __init__(self,
        ...
        tf.function(lambda: tf.compat.v1.global_variables_initializer())
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('train'):
            self._train_op = tf.keras.optimizers.RMSprop(self.lr).minimize(self.loss)
    ...
    def choose_action(self, observation):
        ...
        if np.random.uniform() < self.epsilon:
            ...
            actions_value = tf.function(lambda: self.q_eval,
    ...
    def learn(self):
        ...
        if self.learn_step_counter % self.replace_target_iter == 0:
            ...
            tf.function(lambda: self.replace_target_op)
        ...
        q_next, q_eval4next = tf.function(lambda: 
        ...
        q_eval = tf.function(lambda: self.q_eval, {self.s: batch_memory[:, :self.n_features],
        ...
        _, self.cost = tf.function(lambda: [self._train_op, self.loss],
